...
Do not "helpfully" disable things for me:#+begin_src emacs-lisp
  (put 'downcase-region 'disabled nil)
  (put 'upcase-region 'disabled nil)
  (put 'narrow-to-region 'disabled nil)
#+end_src

Allows typing just "y" instead of "yes" when you exit:#+begin_src emacs-lisp
...
Fri May 22 19:32:12 EDT 2009#+begin_src emacs-lisp
...
Sun Dec 14 00:04:46 EST 2008#+begin_src emacs-lisp
...
*** Javascript#+BEGIN_SRC emacs-lisp
...
visual lines, not logical lines.#+begin_src emacs-lisp
  (with-eval-after-load 'org
    (add-hook 'org-mode-hook #'visual-line-mode))
#+end_src

Show leading stars!#+begin_src emacs-lisp
...
,#+STARTUP: indent
,#+STARTUP: noindent
#+end_example#+begin_src emacs-lisp
...
Store clock data, state changes, and state notes are in the LOGBOOK drawer:#+begin_src emacs-lisp
...
automatically save bookmarks when it is killed.#+begin_src emacs-lisp
...
#+begin_src emacs-lisp :tangle no
  ...
  (setq ibuffer-my-manual-saved-groups
	'(("magit" (name .".*magit"))
	  ("mig: wpl"
	   (or (filename . "code/mig/wpl-collectionspace-migration")
	       (filename . "data/wpl_westerville_public_library")))
	  ...
	  ("meta" (or
		   ...
		   (basename . "migrations.org")
		   (basename . "work.org")))))
  (setq ibuffer-my-all-saved-groups (append ibuffer-my-manual-saved-groups ibuffer-my-vc-groups))
  (setq ibuffer-saved-filter-groups '(("filters"
				       (append
					ibuffer-my-manual-saved-groups
...
Setting =ivy-intial-inputs-alist= to nil turns off the default behavior of starting filters with =^=.#+BEGIN_SRC emacs-lisp
  (use-package ivy
    :ensure t
    :diminish ivy-mode
    :config
